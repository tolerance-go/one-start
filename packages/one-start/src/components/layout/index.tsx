...
import type { OSLayoutAPI, OSLayoutType, OSNavItem } from '../typings/layout';
...
const OSLayout: React.ForwardRefRenderFunction<OSLayoutAPI, OSLayoutType> = (props, ref) => {
...
export default React.forwardRef(OSLayout);

export const Settings: React.FC<OSLayoutType['settings']> = () => <></>;
export const Requests: React.FC<OSLayoutType['requests']> = () => <></>;
