...
export const ActionsTemplateUploadSettings: React.FC<OSActionsTemplateUploadType['settings']> =
  () => <></>;
export const ActionsTemplateUploadRequests: React.FC<OSActionsTemplateUploadType['requests']> =
  () => <></>;
